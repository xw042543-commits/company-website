...
export const UNIVERSITY_CATALOG: UniversityCatalogEntry[] = [
  ...
  { id: "apu", slug: "asia-pacific-university", nameZh: "亚太科技大学", nameEn: "Asia Pacific University of Technology & Innovation", countryZh: "马来西亚", countryEn: "Malaysia", countryCode: "MY", continentCode: "AS", cityZh: "吉隆坡", cityEn: "Kuala Lumpur", logoSrc: "/universities/asia-pacific-university.png", aliases: ["APU", "Asia Pacific University", "亚太大学", "亚太科技"], programmeStatus: "pending" },
  ...
  { id: "utar", slug: "universiti-tunku-abdul-rahman", nameZh: "拉曼大学", nameEn: "Universiti Tunku Abdul Rahman", countryZh: "马来西亚", countryEn: "Malaysia", countryCode: "MY", continentCode: "AS", cityZh: "金宝与双溪龙", cityEn: "Kampar and Sungai Long", logoSrc: "/universities/universiti-tunku-abdul-rahman.png", aliases: ["UTAR", "Tunku Abdul Rahman University", "拉曼"], programmeStatus: "pending" },
